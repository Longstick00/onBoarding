...
class GrandFather:
    def greet(self):
        return "Hello, I am your Grandfather."


class FatherA(GrandFather):
    def greet(self):
        return "Hi, I am your Father from side A."


class FatherB(GrandFather):
    def greet(self):
        return "Hi, I am your Father from side B."
...
son = Son()
print(son.greet())  # 출력: "Hi, I am your Father from side A."
